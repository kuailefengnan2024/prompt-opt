...
from promptopt.optimizer.slow_update import format_comparison_text
...
def run_meta_prompt(
    ...
    *,
    ...
    actual_system = system_prompt if system_prompt is not None else load_template("meta_prompt")
