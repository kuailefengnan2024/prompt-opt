You will be given several successful agent trajectories from one minibatch and the current prompt document.

Summarize any useful lessons from these trajectories into one complete replacement prompt document.
