"""【功能描述】SkillOpt 优化器 — 可优化 prompt 文档更新，类比 NN optimizer，将 patches 应用到当前 prompt 生成候选。
...
"""
from skillopt.optimizer.prompt_editor import apply_edit, apply_patch  # noqa: F401
